...
const page = () => {
    ...
    return (
        <div className="w-full max-w-screen-lg mx-auto">
            <div className="flex items-center justify-center h-24 text-4xl font-bold border-dark">Quartz Dev Store</div>
            {allProducts.length > 0 ? <>
                ...
                <div className="flex justify-center mt-4 mb-4">
                    ...
                    <button
                        ...
                        className={`mx-1 px-4 py-2 bg-gray-200 rounded-full ${currentPage === totalPages ? "cursor-not-allowed" : "hover:bg-gray-300"
                            }`}
                    >
                        Next
                    </button>
